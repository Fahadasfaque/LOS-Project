...
export default function LandingPage() {
  ...
  useGSAP(() => {
    ...
    const setter = gsap.quickSetter(".animate-marquee", "animationDuration", "s");
    const clamp = gsap.utils.clamp(8, 20);
    ScrollTrigger.create({
      onUpdate: (self) => {
        const velocity = Math.abs(self.getVelocity());
        const duration = clamp(20 - (velocity / 100));
        setter(duration);
      }
    });
  });
    ...
    <div data-theme={dark ? 'dark' : 'light'} style={{minHeight:'100vh', fontFamily:"'Inter', system-ui, -apple-system, sans-serif"}}>
      ...
      <section id="trusted">
        <div id="trusted-inner">
          ...
          <div id="trusted-logos" className="mask-edges" style={{ overflow: 'hidden' }}>
      ...
      <section id="journey">
        <div id="journey-inner">
          ...
          <div id="journey-steps" onMouseEnter={() => setJourneyHover(true)} onMouseLeave={() => setJourneyHover(false)}>
      ...
      <section id="modules">
        <div id="modules-inner">
          ...
          <div id="modules-grid" onMouseEnter={() => setModuleHover(true)} onMouseLeave={() => setModuleHover(false)}>
            {[
          ...
          <div id="security-left">
            ...
            <div id="security-grid">
              {[
                ...
                <div key={title} className="security-item security-item-gsap">
            ...
            <div id="metrics-grid">
              {[
                ...
                <div key={label} className="metric-card">
                  <div className="metric-value"><span className="metric-value-gsap">{value}</span><span className="metric-unit">{unit}</span></div>
      ...
      <section id="testimonials">
        <div id="testimonials-inner">
          ...
          <div id="testimonials-grid" style={{ overflow: 'hidden' }}>
