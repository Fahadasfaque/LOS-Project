    ...
    <div data-theme={dark ? 'dark' : 'light'} style={{minHeight:'100vh', fontFamily:"'Inter', system-ui, -apple-system, sans-serif"}}>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ai-badge span { font-size: 12px; font-weight: 600; color: var(--primary); letter-spacing: 0.3px; text-transform: uppercase; }
        #ai-headline { font-size: 44px; font-weight: 800; color: var(--navy); line-height: 1.1; letter-spacing: -1.5px; margin-bottom: 20px; transition: color 0.35s; }
        #ai-headline .ai-gradient { background: linear-gradient(135deg, #3b82f6, #6366f1, #8b5cf6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
        #ai-subtitle { font-size: 17px; color: var(--text-secondary); line-height: 1.7; margin-bottom: 36px; max-width: 460px; transition: color 0.35s; }
        .ai-capabilities { display: flex; flex-direction: column; gap: 16px; margin-bottom: 40px; }
        .ai-capability { display: flex; align-items: flex-start; gap: 14px; }
        .ai-cap-icon {
          width: 40px; height: 40px; border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;
        }
        .ai-cap-icon.blue { background: rgba(59,130,246,0.08); border: 1px solid rgba(59,130,246,0.15); }
        .ai-cap-icon.emerald { background: rgba(16,185,129,0.08); border: 1px solid rgba(16,185,129,0.15); }
        .ai-cap-icon.violet { background: rgba(139,92,246,0.08); border: 1px solid rgba(139,92,246,0.15); }
        .ai-cap-text {}
        .ai-cap-title { font-size: 14px; font-weight: 700; color: var(--navy); margin-bottom: 2px; transition: color 0.35s; }
        .ai-cap-desc { font-size: 13px; color: var(--text-secondary); line-height: 1.5; transition: color 0.35s; }
        .ai-cta-row { display: flex; align-items: center; gap: 16px; flex-wrap: wrap; }
        .ai-cta-primary {
        ...
        .ai-cta-primary:hover { transform: translateY(-1px); box-shadow: 0 8px 32px rgba(79,70,229,0.45); }
        .ai-cta-secondary {
          font-size: 14px; font-weight: 600; color: var(--primary);
          display: inline-flex; align-items: center; gap: 6px; cursor: pointer;
          text-decoration: none; transition: gap 0.2s;
        }
        .ai-cta-secondary:hover { gap: 10px; }
        .ai-security-note { display: flex; align-items: center; gap: 6px; margin-top: 20px; }
        .ai-security-note span { font-size: 11px; color: var(--text-muted); font-weight: 500; }

        /* Chat mockup */
        #ai-right { position: relative; }
        #ai-chat-mockup {
        ...
        .ai-chat-name { font-size: 13px; font-weight: 700; color: #f1f5f9; }
        .ai-chat-sub { font-size: 10px; color: rgba(148,163,184,0.8); margin-top: 1px; }
        .ai-chat-status { display: flex; align-items: center; gap: 6px; }
        .ai-status-dot { width: 7px; height: 7px; border-radius: 50%; background: #22c55e; animation: dotBlink 2s ease-in-out infinite; }
        .ai-status-text { font-size: 10px; color: rgba(148,163,184,0.8); font-weight: 500; }
        .ai-chat-body { padding: 20px; display: flex; flex-direction: column; gap: 16px; background: var(--db-body); min-height: 320px; }

        /* Chat bubbles */
        .ai-bubble-user { display: flex; justify-content: flex-end; }
        .ai-bubble-user .bubble-inner {
          max-width: 78%; background: #2563eb; color: #fff;
          border-radius: 16px 16px 4px 16px; padding: 10px 14px;
          font-size: 12px; line-height: 1.5; font-weight: 500;
        }
        .ai-bubble-asst { display: flex; gap: 10px; align-items: flex-start; }
        .ai-bubble-asst-avatar {
          width: 28px; height: 28px; border-radius: 8px; shrink: 0; flex-shrink: 0;
          background: linear-gradient(135deg, #3b82f6, #6366f1);
          display: flex; align-items: center; justify-content: center; margin-top: 1px;
        }
        .ai-bubble-asst .bubble-inner {
          max-width: 85%; background: var(--card-bg); border: 1px solid var(--border);
          border-radius: 4px 16px 16px 16px; padding: 10px 14px;
          font-size: 12px; line-height: 1.6; color: var(--text-secondary);
          transition: background 0.35s, border-color 0.35s;
        }
        .ai-bubble-asst .bubble-strong { font-weight: 700; color: var(--navy); }
        .ai-typing { display: flex; align-items: center; gap: 10px; }
        .ai-typing-dots { display: flex; gap: 4px; }
        .ai-typing-dot { width: 6px; height: 6px; border-radius: 50%; background: #3b82f6; }
        .ai-typing-dot:nth-child(1) { animation: aiDotBounce 1.2s ease-in-out 0s infinite; }
        .ai-typing-dot:nth-child(2) { animation: aiDotBounce 1.2s ease-in-out 0.15s infinite; }
        .ai-typing-dot:nth-child(3) { animation: aiDotBounce 1.2s ease-in-out 0.3s infinite; }
        @keyframes aiDotBounce { 0%,80%,100%{transform:translateY(0)} 40%{transform:translateY(-5px)} }
        .ai-chat-input-bar {
          padding: 14px 16px; border-top: 1px solid var(--border); background: var(--card-bg);
          display: flex; align-items: center; gap: 10px; transition: background 0.35s, border-color 0.35s;
        }
        .ai-chat-input {
          flex: 1; font-size: 12px; color: var(--text-muted); font-style: italic;
        }
        .ai-chat-send {
        ...
        .ai-glow-orb {
          position: absolute; border-radius: 50%; filter: blur(48px); pointer-events: none; z-index: -1;
        }
        .ai-glow-1 { width: 280px; height: 280px; background: rgba(99,102,241,0.12); top: -60px; right: -60px; }
        .ai-glow-2 { width: 200px; height: 200px; background: rgba(59,130,246,0.10); bottom: -40px; left: -40px; }

        @media (max-width: 900px) {
          #ai-section-inner { grid-template-columns: 1fr; gap: 48px; }
          #ai-headline { font-size: 34px; }
          #ai-right { order: -1; }
        }
      `}</style>
      ...
      <section id="ai-section">
        <div id="ai-section-inner">
          {/* Left — copy */}
          <div id="ai-left">
            <div className="ai-badge">
              <span className="ai-badge-dot" />
              <span>New · Fortress AI</span>
            </div>

            <h2 id="ai-headline">
              Meet your<br />
              <span className="ai-gradient">Banking Intelligence</span><br />
              Assistant
            </h2>
            <p id="ai-subtitle">
              An enterprise-grade AI co-pilot built directly into your loan origination workflow.
              Ask questions, analyze risk, verify compliance — all in natural language.
            </p>

            <div className="ai-capabilities">
              <div className="ai-capability">
                <div className="ai-cap-icon blue">
                ...
                <div className="ai-cap-text">
                  <div className="ai-cap-title">Intelligent Loan Analysis</div>
                  <div className="ai-cap-desc">Instantly evaluate applications, check DTI ratios, credit eligibility and generate recommendations.</div>
                </div>
              </div>
              <div className="ai-capability">
                <div className="ai-cap-icon emerald">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                  </svg>
                </div>
                <div className="ai-cap-text">
                  <div className="ai-cap-title">Compliance Guidance</div>
                  <div className="ai-cap-desc">KYC/AML checks, regulatory frameworks, and real-time compliance alerts in plain English.</div>
                </div>
              </div>
              <div className="ai-capability">
                <div className="ai-cap-icon violet">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>
                  </svg>
                </div>
                <div className="ai-cap-text">
                  <div className="ai-cap-title">Portfolio Risk Intelligence</div>
                  <div className="ai-cap-desc">Monitor NPL trends, early warning signals, and get proactive risk alerts before they escalate.</div>
                </div>
              </div>
            </div>

            <div className="ai-cta-row">
              <button onClick={openAI} className="ai-cta-primary">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>
                </svg>
                Try Fortress AI
              </button>
              <button onClick={openAI} className="ai-cta-secondary">
                See it in action
            ...
            <div className="ai-security-note">
              ...
              <span>256-bit encrypted · No data stored · SOC-2 compliant</span>
            </div>
          </div>

          {/* Right — chat mockup */}
          <div id="ai-right">
            <div className="ai-glow-orb ai-glow-1" />
            <div className="ai-glow-orb ai-glow-2" />
            <div id="ai-chat-mockup">
              {/* Header */}
              <div className="ai-chat-header">
                <div className="ai-chat-brand">
                  ...
                  <div>
                    <div className="ai-chat-name">Fortress AI</div>
                    <div className="ai-chat-sub">Banking Intelligence Assistant</div>
                  </div>
                </div>
                <div className="ai-chat-status">
                  <div className="ai-status-dot" />
                  <div className="ai-status-text">Online</div>
                </div>
              </div>
              ...
              <div className="ai-chat-body">
                ...
                <div className="ai-bubble-user">
                  <div className="bubble-inner">
                    What's the DTI threshold for home loan approval?
                  </div>
                </div>

                {/* Assistant response */}
                <div className="ai-bubble-asst">
                  <div className="ai-bubble-asst-avatar">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      <rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/>
                    </svg>
                  </div>
                  <div className="bubble-inner">
                    For home loans, we apply a <span className="bubble-strong">two-tier DTI framework:</span><br /><br />
                    • <span className="bubble-strong">Front-end DTI ≤ 28%</span> — housing costs only<br />
                    • <span className="bubble-strong">Back-end DTI ≤ 43%</span> — all obligations<br /><br />
                    With strong compensating factors (750+ CIBIL, 12 months reserves), exceptions up to 50% are permitted with approver sign-off.
                  </div>
                </div>
                ...
                <div className="ai-bubble-user">
                  <div className="bubble-inner">
                    Show me current portfolio risk signals
                  </div>
                </div>
                ...
                <div className="ai-bubble-asst">
                  ...
                  <div className="bubble-inner" style={{padding: '10px 14px'}}>
              ...
              <div className="ai-chat-input-bar">
                <div className="ai-chat-input">Ask about loans, compliance, risk…</div>
